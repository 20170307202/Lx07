    ...
    public class WorkInfo
    {
        ...
        public IEnumerable<Model.WorkInfoNo> GetPage(Model.WorkPage page)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                ...
                return cn.Query<Model.WorkInfoNo>(sql, new { pageIndex=page.pageIndex,pageSize=page.pageSize,sctivityIds=page.activityIds});
            }
        }
        ...
        public int Add(Model.WorkInfo workinfo)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "insert into WorkInfo(workinfo,workName,workPicture,uploadTime,workIntroduction,workVerify,userName,activityId,recommend,recommendTime)"+
